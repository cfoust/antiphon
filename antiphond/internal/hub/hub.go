...
// agents, and the management/debug endpoints. The wire protocol is documented in plugins/README.md.
package hub
...
// session — the client must NOT reconnect (antiphond/internal/channel honors it).
...
func (h *Hub) handleAgent(w http.ResponseWriter, r *http.Request) {
	...
	// (prototype antiphon-channel) sends a narration event first — give it an
...
// ladder — and broadcasts it to every antiphon client.
